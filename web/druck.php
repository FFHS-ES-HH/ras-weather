<?php
	 ...
	 *
	 * druck.php is free software copyrighted by Andreas Hasler.
	 *
...
<html>
	...
	<body>
				...
				<td colspan="2">
					<table cellpadding="0" cellspacing="0">
						<tr style="height: 43px">
							...
							Luftfeuchtigkeit</td>
							<td style="width: 5px"></td>
							<td class="NavigationTabSelected" style="cursor: pointer" onclick="document.location.href='druck.php';">
							Luftdruck</td>
							<td style="width: 5px"></td>
		...
		<p>Letzte Messung: <?php echo DatabaseHandler::getLastPressure(); ?></p>
		
		<h3>Die letzten 10 Messwerte</h3>
		
		<p><img src="druck_graph.php" alt="[Keine Messwerte - Diagramm kann nicht dargestellt werden]"></p>
	</body>
</html>
