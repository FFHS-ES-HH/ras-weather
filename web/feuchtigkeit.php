<?php
	 ...
	 *
	 * feuchtigkeit.php is free software copyrighted by Andreas Hasler.
	 *
...
<html>
	...
	<body>
				...
				<td colspan="2">
					<table cellpadding="0" cellspacing="0">
						<tr style="height: 43px">
							...
							<td class="NavigationTabSelected" style="cursor: pointer" onclick="document.location.href='feuchtigkeit.php';">
							Luftfeuchtigkeit</td>
							<td style="width: 5px"></td>
		...
		<p>Letzte Messung: <?php echo DatabaseHandler::getLastHumidity(); ?></p>
		
		<h3>Die letzten 10 Messwerte</h3>
		
		<p><img src="feuchtigkeit_graph.php" alt="[Keine Messwerte - Diagramm kann nicht dargestellt werden]"></p>
	</body>
</html>
